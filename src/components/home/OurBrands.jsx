    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-6 lg:grid-cols-6 p-4">
        {brands.map((brand, index) => (
          <div
            key={index}
            className="flex justify-center items-center border border-gray-200 p-4 opacity-20 cursor-pointer hover:opacity-100 hover:bg-white hover:transition-all hover:ease-in-out"
          >
